...
dataset_file = 'C:/Users/ASUS/Documents/Thesis/Code/Python/SoureCode/fdata-2020.db'
...
class ArSentiment(object):
    def __init__(self, embeddings_file=None, dataset_file=None, plot_roc=False, split=0.80 , detailed=False):
        ...
        # classifiers to use
        classifiers = [
            XGBClassifier(learning_rate = 0.1, n_estimators=300, max_depth=5),
            XGBClassifier(learning_rate = 0.1, n_estimators=300, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=500, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=600, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=900, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=1000, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=1300, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=1500, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=2000, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
            XGBClassifier(learning_rate = 0.1, n_estimators=5000, max_depth=5, min_child_weight = 1, gamma = 0, subsample = 0.8, colsample_bytree = 0.8, scale_pos_weight = 1),
        ]
        ...
        for c in classifiers:
            self.classify(c, idx, detailed, plot_roc)
            idx += 1
        ...
        add_test_to_database(allresults, classifiers_params)
...
if __name__ == "__main__":
    ...
    dataset_path = args.dataset if args.dataset else "C:/Users/ASUS/Documents/Thesis/Code/Python/SoureCode/thesis-trainset.csv"
    # run
