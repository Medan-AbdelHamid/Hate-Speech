...
class ArSentiment(object):
    def __init__(self, embeddings_file=None, dataset_file=None, plot_roc=False, split=0.80 , detailed=False):
        ...
        # info("fitting ... ")
        bestModel, bestScore, allModels, allScores = pf.bestFit(LogisticRegression, paramGrid, self.X_train, self.y_train, self.X_test, self.y_test, metric = roc_auc_score, scoreLabel = "AUC")
