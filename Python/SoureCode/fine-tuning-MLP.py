...
class ArSentiment(object):
    def __init__(self, embeddings_file=None, dataset_file=None, plot_roc=False, split=0.80 , detailed=False):
        ...
        param_test1 = {
            'hidden_layer_sizes': [(150, 100, 100), (150, 150, 150), (100,100,100)],
            # 'activation': ['identity', 'logistic', 'tanh', 'relu'], # best 'relu'
            # 'solver': ['lbfgs', 'sgd', 'adam'], # best 'adam'
            # 'alpha': [0.0001, 0.05], # best 0.05
            # 'learning_rate': ['constant', 'invscaling', 'adaptive'], # best 'invscaling'
            }
        gsearch1 = GridSearchCV(estimator = MLPClassifier(activation='relu', solver='adam', alpha=0.05, learning_rate = 'invscaling', max_iter=1000), 
        ...
        self.best_params_ = gsearch1.best_params_
