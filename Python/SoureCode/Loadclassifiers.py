...
class ArSentiment(object):
    def __init__(self, embeddings_file=None, dataset_file=None, plot_roc=False, split=0.08 , detailed=False):
        ...
        classifiers = [    
            ...
            #XGBClassifier(learning_rate = 0.05, n_estimators=300, max_depth=5,base_score=0.7, booster='gbtree',colsample_bylevel=1, gamma=0,subsample=0.5),
...
if __name__ == "__main__":
    ...
    dataset_path = args.dataset if args.dataset else "C:/Users/ASUS/Documents/Thesis/Code/Python/SoureCode/cleantest500-2.csv"
